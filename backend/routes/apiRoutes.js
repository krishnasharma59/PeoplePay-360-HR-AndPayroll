...
import { approvePayroll, approvePayslip, calculatePayroll, cancelPayrollReview, createOffCyclePayout, createPayrollRun, getAllPayslips, getPayslipPdf, getPayslips, rejectPayslip, unapprovePayroll } from "../controllers/payrollController.js";
...
router.patch("/contracts/:id", allowRoles(...HR_ROLES), updateContract);
...
router.post("/payroll-runs/off-cycle", allowRoles(...PAYROLL_ROLES), createOffCyclePayout);
