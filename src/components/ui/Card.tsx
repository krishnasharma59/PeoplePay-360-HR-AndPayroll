...
export function Card({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn('bg-white border border-slate-200/90 rounded-xl shadow-card transition-shadow', className)}
      {...props}
    >
      {children}
    </div>
...
export function CardFooter({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn('px-6 py-3.5 bg-slate-50/50 border-t border-slate-100 rounded-b-xl flex items-center', className)} {...props}>
      {children}
    </div>
  );
}